...
#ifndef PROTOBUF_INCLUDED_remotexec_2eproto
#define PROTOBUF_INCLUDED_remotexec_2eproto
...
class ExecuteRequest final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.ibm.cloudland.scripts.ExecuteRequest) */ {
 public:
  ExecuteRequest();
...
class ExecuteReply final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.ibm.cloudland.scripts.ExecuteReply) */ {
 public:
  ExecuteReply();
  ...
  ExecuteReply* New(::google::protobuf::Arena* arena) const final {
...
class FileChunk final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.ibm.cloudland.scripts.FileChunk) */ {
 public:
  FileChunk();
  virtual ~FileChunk();
  ...
  ::google::protobuf::int64 fileseek() const;
  void set_fileseek(::google::protobuf::int64 value);
 ...
 private:
  ...
  ::google::protobuf::int64 fileseek_;
...
class TransmitAck final :
    public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:com.ibm.cloudland.scripts.TransmitAck) */ {
 public:
  TransmitAck();
  virtual ~TransmitAck();
  ...
  TransmitAck* New(::google::protobuf::Arena* arena) const final {
...
inline ::google::protobuf::int32 ExecuteRequest::id() const {
  // @@protoc_insertion_point(field_get:com.ibm.cloudland.scripts.ExecuteRequest.id)
  return id_;
}
inline void ExecuteRequest::set_id(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int32 ExecuteRequest::extra() const {
  // @@protoc_insertion_point(field_get:com.ibm.cloudland.scripts.ExecuteRequest.extra)
  return extra_;
}
inline void ExecuteRequest::set_extra(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int32 FileChunk::id() const {
  // @@protoc_insertion_point(field_get:com.ibm.cloudland.scripts.FileChunk.id)
  return id_;
}
inline void FileChunk::set_id(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int32 FileChunk::filesize() const {
  // @@protoc_insertion_point(field_get:com.ibm.cloudland.scripts.FileChunk.filesize)
  return filesize_;
}
inline void FileChunk::set_filesize(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int32 FileChunk::checksum() const {
  // @@protoc_insertion_point(field_get:com.ibm.cloudland.scripts.FileChunk.checksum)
  return checksum_;
}
inline void FileChunk::set_checksum(::google::protobuf::int32 value) {
...
inline ::google::protobuf::int64 FileChunk::fileseek() const {
  // @@protoc_insertion_point(field_get:com.ibm.cloudland.scripts.FileChunk.fileseek)
  return fileseek_;
}
inline void FileChunk::set_fileseek(::google::protobuf::int64 value) {
...
inline ::google::protobuf::int32 FileChunk::extra() const {
  // @@protoc_insertion_point(field_get:com.ibm.cloudland.scripts.FileChunk.extra)
  return extra_;
}
inline void FileChunk::set_extra(::google::protobuf::int32 value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // PROTOBUF_INCLUDED_remotexec_2eproto
