...
tar -xvzf $PEG_PKG &>> "$LOG_FILE"
check_status

# Change directory
log "Changing directory to PEG_Ubuntu_22.04_mlnxDriver_deps/archives/..."
safe_cd "PEG_Ubuntu_22.04_mlnxDriver_deps/archives/"
...
if [ "$1" == "computingnode" ]; then
    ...
    safe_cd "PEG_Ubuntu_22.04_mlnxDriver_deps/archives/computingnode/"
...
OFED_PKG=MLNX_OFED_LINUX-5.8-3.0.7.0-ubuntu22.04-x86_64.tgz
wget https://dev-repo.raksmart.com/packages/WDS/computingnode/$OFED_PKG
log "Extracting $OFED_PKG..."
tar -xvzf $OFED_PKG &>> "$LOG_FILE"
check_status

# Change directory to MLNX_OFED_LINUX
log "Changing directory to MLNX_OFED_LINUX..."
safe_cd "MLNX_OFED_LINUX-5.8-3.0.7.0-ubuntu22.04-x86_64"
