...
INSERT  INTO "subnets" ("id","created_at","updated_at","deleted_at","name","network","netmask","gateway","start","end","vlan","type","router") VALUES (1,'$datetime','$datetime',NULL,'public','192.168.71.0','255.255.255.0','192.168.71.1/24','192.168.71.100','192.168.71.150',5000,'public',0) RETURNING "subnets"."id";
