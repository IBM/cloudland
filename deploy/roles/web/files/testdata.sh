...
INSERT  INTO "images" ("id","created_at","updated_at","deleted_at","name","os_code","format","architecture","status","href","checksum") VALUES (2,'$datetime','$datetime',NULL,'ubuntu1804','bionic','qcow2','x86-64','available','','') RETURNING "images"."id";
INSERT  INTO "images" ("id","created_at","updated_at","deleted_at","name","os_code","format","architecture","status","href","checksum") VALUES (3,'$datetime','$datetime',NULL,'ubuntu1604','xenial','qcow2','x86-64','available','','') RETURNING "images"."id";
