...
INSERT  INTO "images" ("id","created_at","updated_at","deleted_at","name","os_code","format","architecture","status","href","checksum") VALUES (1,'$datetime','$datetime',NULL,'centos7','core','qcow2','x86-64','available','','') RETURNING "images"."id";
INSERT  INTO "images" ("id","created_at","updated_at","deleted_at","name","os_code","format","architecture","status","href","checksum") VALUES (1,'$datetime','$datetime',NULL,'ubuntu1804','bionic','qcow2','x86-64','available','','') RETURNING "images"."id";
INSERT  INTO "images" ("id","created_at","updated_at","deleted_at","name","os_code","format","architecture","status","href","checksum") VALUES (1,'$datetime','$datetime',NULL,'ubuntu1604','xenial','qcow2','x86-64','available','','') RETURNING "images"."id";
