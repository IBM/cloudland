...
rsync -a --include={'web/clui/public/misc/openshift/*.sh','web/clui/frontend/build'} --exclude={'.git','cache/*','run/*','log/*','etc/*','scripts/cloudrc.local','web/clui/conf/config.toml','web/clui/frontend/*','web/clui/public/misc/openshift/*','deploy/conf.json'} /opt/cloudland /tmp/opt
